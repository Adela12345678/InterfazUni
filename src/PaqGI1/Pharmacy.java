...
public class Pharmacy extends JFrame {
    ...
    public void refillOneMedicine(String nameMedicine,String companyName, int amount) {
        for (Dispenser dispenser : dispensers) {
            dispenser.refillSpecificMedicine(nameMedicine,companyName, amount);
        }
    }
    ...
    public void refill(String nameMedicine, String companyName, int amount) {
        for (Dispenser dispenser : dispensers) {
            dispenser.refillSpecificMedicine(nameMedicine, companyName, amount);
        }
